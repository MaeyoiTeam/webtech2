             ...
             <article >
                 ...
                 <div class="content" >
                     ...
                     Date :<select name='date'>
                         <?php $date = "SELECT coursedate.date_date FROM coursedate WHERE coursedate.sec='".$_SESSION['sec']."' AND coursedate.course_ID ='".$_SESSION['course_ID']."'  AND coursedate.date_date >= '".$start."'";
