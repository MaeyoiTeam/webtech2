...
if($objResult ){
    echo "<script LANGUAGE='JavaScript'>window.alert('Upload Success".$txt[0]..$txt[1]."');window.location.href='../course_teacher.php';</script>";
}
else{
echo "<script LANGUAGE='JavaScript'>window.alert('Upload Fail".$txt[0]..$txt[1]."');window.location.href='../course_teacher.php';</script>";
}
